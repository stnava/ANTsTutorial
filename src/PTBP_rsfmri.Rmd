...
if ( file.exists(aalfn) ) {
  ...
  mnia = antsImageRead( getANTsRData( "mnia" ) )
  ...
  # how can we improve on this?  composition? better reference?
  }
```
...
gmet <- makeGraph( tsavgcor, graphdensity = 0.1, communityMethod = 'greedy' )
```
