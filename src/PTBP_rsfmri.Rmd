...
dd="/Users/stnava/data/NeuroBattery/"
pre=paste(dd,"/data/input/PEDS012/20131101/",sep='')
post=paste(dd,"/data/output/PEDS012/20131101/",sep='')
...
```{r igrvizbrain,eval=FALSE}
 ...
 plotBasicNetwork( centroids = aalcnt, brain, weights=metweights, scaling=c(1,2) )
```
