...
if ( ! exists("sccan") )
  sccan=sparseDecom2(inmatrix, c(famask, NA),
     sparseness = c( 0.01, 0.3 ),
     nvecs = 10, its = 30, cthresh = c(5000, 0),
     perms = 0, smooth = 0.0, mycoption = 0 )
```
...
ccaeseg=eigSeg( famask, sccan$eig1, FALSE  )
...
sccanmat=imageListToMatrix( sccan$eig1, famask)
sccanmat=sccanmat/rowSums(sccanmat)
sccanproj = famat[haveAllMerge,] %*% t( sccanmat )
